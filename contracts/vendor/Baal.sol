...
// ZERO ONE FORK of @daohaus/baal-contracts 1.2.18 Baal.sol (decision.md "phase 5 rulings" 1 and 2).
// Every change is marked "ZERO ONE:"; the diff is recorded in docs/PARAMETERS.md. Nothing else differs.
...
import "@openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol"; /* ZERO ONE: explicit (resolved transitively by the package build) */
...
contract Baal is Module, EIP712Upgradeable, ReentrancyGuardUpgradeable, BaseRelayRecipient {
    ...
    *****************/
    ...
    function submitProposal(
        ...
        require(baalGas <= 8000000, "baalGas to high"); /* ZERO ONE: relay sponsor maximum, under Base's EIP-7825 tx cap (ruling 1) */
