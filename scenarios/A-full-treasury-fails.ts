 ...
 */
import { assert, boot, expectRevert, processProposal, propose, runIfMain, seedMembers, shutdown, snapshot, stateOf, step, transferCall, verdict, vote, warpPastGrace, warpPastVoting } from "./lib.js";
...
export async function main(): Promise<void> {
  ...
  try {
    ...
    assert(after.safeSettlement === treasury, `treasury unchanged at ${treasury}`);
